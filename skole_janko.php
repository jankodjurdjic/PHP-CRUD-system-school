...
/* 1 - ukljucujemo fajlove potrebne za ovaj dio koda*/
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if(isset($_POST['modal_new']) && $_POST['modal_new'] == 'new_school')
    {
        ...
        if($inserted>0){
            ...
            $alert->setErrorAlert("Desila se greska, nova skola nije unesena.");
        }
    }
    ...
    if(isset($_POST['modal_edit']) && $_POST['modal_edit'] == 'edit_school')
    {
        ...
        if($edited>0){
            ...
            $alert->setErrorAlert("Desila se greska, podaci o skoli nisu promjenjeni.");
        }
    }
    ...
    if(isset($_POST['modal_delete']) && $_POST['modal_delete'] == 'delete_school')
    {
        ...
        if($deleted>0){
            ...
            $alert->setErrorAlert("Desila se greska, skola nije izbrisana.");
        }
    }
}

/* 7 - pretraga i paginacija*/
$where_clause = '';
$default_url = 'skole_janko.php';
$pagination_url = 'skole_janko.php?p=[p]';
$search_term = '';
if($_SERVER['REQUEST_METHOD'] === 'GET'){
    if(isset($_GET['search'])){
        $where_clause = " WHERE (skole.skola_naziv LIKE '%".$_GET['search']."%')";
        $default_url = 'skole_janko.php?search='.$_GET['search'];
        $pagination_url = 'skole_janko.php?search='.$_GET['search'].'&p=[p]';
...
/* 9 - podesavanje za main_menu*/
$active_menu_item = 'skole';

/* 10 - podesavanje za breadcrumbs*/
$breadcrumbs = array(
    array(
        'title' => 'Home',
        'active' => false,
...
<head>
    ...
    <!-- 11 - naslov stranice i ukljucivanje skripti koje se koriste u fajlu-->
    <title>Skole</title>
...
<?php include("modals_janko/modal_new_school.php"); ?>

<?php include("modals_janko/modal_edit_school.php"); ?>

<?php include("modals_janko/modal_delete_school.php"); ?>

<!-- 14 - organizovanje fajla-->
<div style="position: absolute; top: 0;left: 0;bottom: 0;right: 0;margin: auto;">
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-8">

            <!-- 15 - blockquote element bootstrap-a-->
            <blockquote class="blockquote-reverse">
                Ministarstvo prosvete
            </blockquote>

            <!-- 16 - ukljucivanje menija, alerta i breadcrumbs-a-->
            ...
            <table class="table table-bordered">
                ...
                <? foreach($schools as $school): ?>
                    <tr>
                        ...
                        <td><a href="http://jpdesign.ba/sime_test/ucenici_janko/details_skole.php?id=<?=$school['skola_id']?>"><img src="http://jpdesign.ba/sime_test/ucenici_janko/assets/img/details.png"></a>&nbsp<a href=""  class = "btn-edit-school" data-id = "<?=$school["skola_id"]?>" data-name = "<?=$school["skola_naziv"]?>" data-jib = "<?=$school["skola_jib"]?>" data-address = "<?=$school["skola_adresa"]?>" data-phone = "<?=$school["skola_telefon"]?>"><img src="http://jpdesign.ba/sime_test/ucenici_janko/assets/img/edit.png"></a>&nbsp<a href="" class = "btn-delete-school" data-id = "<?=$school["skola_id"]?>"><img src="http://jpdesign.ba/sime_test/ucenici_janko/assets/img/delete.png"></a></td>
                    </tr>
                <? endforeach; ?>
            </table>
